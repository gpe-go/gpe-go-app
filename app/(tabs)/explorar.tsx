          ...
          return (
            ...
            >
              ...
              <View style={s.cardInfo}>
                ...
                <Text style={[s.placeName, { fontSize: fonts.sm }]} numberOfLines={1}>
                  {item.nombre}
                </Text>

                <View style={s.locationRow}>
                  <Ionicons name="location-outline" size={11} color={colors.subtext} />
                  <Text style={[s.placeSub, { fontSize: fonts.xs }]} numberOfLines={1}>
                    {item.ubicacion}
                  </Text>
                </View>
                ...
                <View style={s.ratingRow}>
                  ...
                  <Text style={[s.ratingVal, { fontSize: fonts.xs }]}>
                    {item.rating}
                  </Text>
                </View>
